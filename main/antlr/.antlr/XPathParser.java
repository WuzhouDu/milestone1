...
public class XPathParser extends Parser {
	...
	public static final int
		...
		DOC=18, L_PAREN=19, R_PAREN=20, SLASH=21, DOUBLE_SLASH=22, FILENAME=23, 
		STRING=24, ID=25, FOR=26, LET=27, WHERE=28, RETURN=29, IN=30, SATISFIES=31, 
		AND=32, OR=33, NOT=34, EMPTY=35, SOME=36, EQ=37, IS=38, WS=39;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "','", "'<'", "'>'", "'{'", "'}'", "'</'", "':='", "'='", "'=='", 
			"'*'", "'.'", "'..'", "'text()'", "'@'", "'['", "']'", null, "'doc'", 
			"'('", "')'", "'/'", "'//'", null, null, null, "'for'", "'let'", "'where'", 
			"'return'", "'in'", "'satisfies'", "'and'", "'or'", "'not'", "'empty'", 
			"'some'", "'eq'", "'is'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, "Var", "DOC", "L_PAREN", "R_PAREN", "SLASH", 
			"DOUBLE_SLASH", "FILENAME", "STRING", "ID", "FOR", "LET", "WHERE", "RETURN", 
			"IN", "SATISFIES", "AND", "OR", "NOT", "EMPTY", "SOME", "EQ", "IS", "WS"
		};
	}
